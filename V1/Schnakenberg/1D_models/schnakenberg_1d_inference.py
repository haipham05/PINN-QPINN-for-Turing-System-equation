...
def main():
    ...
    print("\n" + "="*80)
    print("SCHNAKENBERG 1D QPINN INFERENCE")
    print("="*80)
    
    # Initialize inference engine
    inference_engine = Schnakenberg1DQPINNInference(config, device)
    
    # Load reference
    ref_path = os.path.join(config.INPUT_DIR, "schnakenberg_reference_solution.npy")
