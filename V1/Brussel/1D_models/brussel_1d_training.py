"""
Brusselator 1D QPINN - Training Script
...
def generate_reference_solution(config, save_path="brusselator_reference_solution.npy"):
...
class Brusselator1DQPINNTrainer:
    """Trainer class for Brusselator 1D QPINN models"""
...
def main():
    ...
    print("\n" + "="*80)
    print("BRUSSELATOR 1D QPINN TRAINING")
    print("="*80)
