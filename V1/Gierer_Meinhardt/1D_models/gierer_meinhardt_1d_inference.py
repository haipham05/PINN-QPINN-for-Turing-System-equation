...
class GiererMeinhardt1DQPINNInference:
    """Inference engine for Gierer-Meinhardt 1D QPINN"""
...
def main():
    ...
    print("\n" + "="*80)
    print("GIERER-MEINHARDT 1D QPINN INFERENCE")
    print("="*80)
    
    # Initialize inference engine
    inference_engine = GiererMeinhardt1DQPINNInference(config, device)
    
    # Load reference
    ref_path = os.path.join(config.INPUT_DIR, "gierer_meinhardt_reference_solution.npy")
