...
class InferenceVisualizer:
    ...
    def plot_performance_analysis(self, save_dir="result"):
        ...
        for embedding_type in ["NONE", "FNN_BASIS", "QNN"]:
            ...
            plt.suptitle(f'Plot 7: {method_name} Performance vs RK45 Reference (Gray-Scott 1D)', 
    ...
    def plot_time_evolution(self, save_dir="result", t_max=1.0):
        ...
        for component in ['u', 'v']:
            ...
            plt.suptitle(f'Plot 8: {component}(t,x) Time Evolution Comparison (Gray-Scott 1D, t∈[0,{t_max}])',
    ...
    def print_summary(self):
        ...
        print("\n" + "="*90)
        print("INFERENCE SUMMARY STATISTICS (Gray-Scott 1D)")
        print("="*90)
...
def main():
    ...
    print("\n" + "="*80)
    print("GRAY-SCOTT 1D QPINN INFERENCE")
    print("="*80)
